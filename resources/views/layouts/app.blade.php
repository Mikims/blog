...
<head>
    ...
    <meta name="author" content="Technology Blog">
...
<body class="bg-gray-50 font-family-karla">
        ...
        <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-between text-sm font-bold uppercase mt-0 px-6 py-2">
                ...
                <div>
                    ...
                    @endforeach
                    <a href="{{route('about-us')}}" class="hover:bg-blue-600 rounded hover:text-white py-2 px-4 mx-2">About us</a>
                </div>
                ...
                <div>
                    ...
                    <div class="flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="hover:bg-blue-600 rounded hover:text-white flex items-center py-2 px-4 mx-2">
                    ...
                    @else
                        <a href="{{route('login')}}" class="hover:bg-blue-600 rounded hover:text-white py-2 px-4 mx-2">Log in</a>
                        <a href="{{route('register')}}" class="bg-blue-600 rounded text-white py-2 px-4 mx-2">Register</a>
                    @endauth 
                </div>
    ...
    <footer class="w-full border-t bg-white pb-12">
        ...
        <!-- images courosel which i have removed-->
        ...
        <div class="w-full container mx-auto flex flex-col items-center">
            <!-- footer links i have removed them -->
    ...
    <!-- javascriptfor images courosel which i have removed-->
